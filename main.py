...
plt.figure(1)
fig, axs = plt.subplots(math.ceil(nchannels/10),10, figsize=(30, math.ceil(nchannels/10*1.2)), facecolor='w', edgecolor='k')
...
for channel in range(0, nchannels):
    ...
    if not math.isnan(peak): pic_freq = np.take(alpha_freqs,peak); pic_freq = 0
